...
bool CPubKey::TweakMulVerify(const CPubKey& res, const uint256& tweak) const
{
    secp256k1_pubkey pk;
    if (!secp256k1_ec_pubkey_parse(secp256k1_context_verify, &pk, this->data(), this->size())) return false;
